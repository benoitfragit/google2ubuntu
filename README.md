...
<ul class="release-downloads">
      ...
      <li>
        <a href="/benoitfragit/google2ubuntu/archive/v1.0.8.zip" rel="nofollow" class="button">
          <span class="octicon octicon-file-zip"></span>
          Source code (zip)
        </a>
      </li>
      <li>
        <a href="/benoitfragit/google2ubuntu/archive/v1.0.8.tar.gz" rel="nofollow" class="button">
          <span class="octicon octicon-file-zip"></span>
          Source code (tar.gz)
        </a>
      </li>
